...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
embed-me.com:gpio_core:gpio_core:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: gpio_core_0, and set properties
  set gpio_core_0 [ create_bd_cell -type ip -vlnv embed-me.com:gpio_core:gpio_core:1.0 gpio_core_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins gpio_core_0/s_axi]
  ...
  connect_bd_net -net gpio_core_0_gpio_o [get_bd_ports gpio_o] [get_bd_pins gpio_core_0/gpio_i] [get_bd_pins gpio_core_0/gpio_o]
  connect_bd_net -net gpio_core_0_irq_o [get_bd_pins gpio_core_0/irq_o] [get_bd_pins processing_system7_0/IRQ_F2P]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins gpio_core_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins gpio_core_0/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs gpio_core_0/s_axi/Reg] -force
